        ...
        <div class="container">
            <div class="row">
	            <div class="col-md-12 d-none d-md-block">
	                <img src="resources/assets/main/img/banner/test.png" alt="banner" class="bnimg">
	            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single_place">
                    <div class="thumb">
                        <img src="resources/assets/main/img/place/1.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_place">
                    <div class="thumb">
                        <img src="resources/assets/main/img/place/2.png" alt="">
                    </div>
                    <div class="place_info">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_place">
                    <div class="thumb">
                        <img src="resources/assets/main/img/place/3.png" alt="">
                    </div>
                    <div class="place_info">
