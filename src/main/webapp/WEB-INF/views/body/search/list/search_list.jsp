					...
					<div class="property-item">
						...
						<a href="guest_house_read?no=${search_data.no}">
							<c:if test="${search_data.thumbnail != null}">
								<img src="resources/assets/main/img/property/${search_data.thumbnail}" alt="">
							</c:if>
							<c:if test="${search_data.thumbnail == null}">
								<img src="resources/assets/main/img/property/6.png" alt="">
							</c:if>
						</a>
						</div>
					...
					<div class="property-item">
						...
						<a href="guest_house_read?no=${guest_house_area_search_data.no}">
							<c:if test="${guest_house_area_search_data.thumbnail != null}">
								<img src="resources/assets/main/img/property/${guest_house_area_search_data.thumbnail}" alt="">
							</c:if>
							<c:if test="${guest_house_area_search_data.thumbnail == null}">
								<img src="resources/assets/main/img/property/6.png" alt="">
							</c:if>
					...
					<div class="property-item">
						...
						<a href="trip_read?no=${trip_area_search_data.no}">
							<c:if test="${trip_area_search_data.thumbnail != null}">
								<img src="resources/assets/main/img/property/${trip_area_search_data.thumbnail}" alt="">
							</c:if>
							<c:if test="${trip_area_search_data.thumbnail == null}">
								<img src="resources/assets/main/img/property/6.png" alt="">
							</c:if>
