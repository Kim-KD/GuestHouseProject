...
function emailcheckbtn() {
	...
	if(!regExp_email.test(user_email)) {
		...
		$('.email50-form-btn').css('background-color','red');
		$("#user_email").val('');
		$("#user_email").focus();
		return false;
	} else {
...
$(function(){
	$('#user_id').blur(function(){
		if($("#id_validation").val() == 1) {
			$('.login50-form-btn').css('background-color','#ff4a52');
		} else {
			$('.focus-input50').css('border','1px solid #ff4a52');
			$('.login50-form-btn').css('background-color','');
		}
	});
	$('#user_email').blur(function(){
		if($("#email_validation").val() == 1) {
			...
			$('.focus-input50').css('border','1px solid #ff4a52');
			$('.email50-form-btn').css('background-color','');
		}
	});
